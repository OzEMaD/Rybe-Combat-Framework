...
Install a Git client, such as the [Github client](https://desktop.github.com/) or [GitKraken](https://www.gitkraken.com/), then clone RCF to your addons folder. With the Github client installed you can click the green button at the top of the RCF repo page and select clone. Updating RCF on your server or client after install simply requires clicking the pull button in your respective Git client.

### Manually

1. Click the green button at the top of the RCF repo and select zip.
2. Extract the RCF folder.
3. Inside you will find another RCF folder.
4. Move the inner RCF folder to `garrysmod/garrysmod/addons`
